...
@section('form_content')
  <h2>Update an existing Mortgage Loan Scenario Information to the Database</h2>
    ...
    <Form method='POST' action='/scenario/update' id='formUpdate'>
        ...
        value= '{{$scenario->scenario_number}}'><br/>
        ...
        value= '{{$scenario->scenario_name}}'><br/>
        ...
        <input type='number' id='interestRateAnnual' step='0.001' min='1.01' name='interestRateAnnual'
        title="In actual numbers, e.g. for 4.5% enter 4.5, Min=1, Max=25"
        value= '{{$scenario->interest_rate_annual}}'><br/>
        ...
        <label for='property'>Select to Update Property*</label>
...
@section('error_content')
    ...
    <p>* Required fields<br/>
       &#8224; Mouseover input box fields for data entry guidance.<br/>
       &#8225; Greayed out input boxes are readonly.
    </p>
    @if(count($errors) > 0)
