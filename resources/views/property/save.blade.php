...
@section('form_content')
  <h2>Save a new Real Estate Property Information to the Database</h2>
  <!--start of form -->
  <Form method='POST' action='/property/save' id='formPropSave'>
        ...
        value= '{{ isset($_POST['propertyNumber']) ? $_POST['propertyNumber'] : '' }} {{old('propertyNumber')}}'><br/>
        ...
        value= '{{ isset($_POST['propertyName']) ? $_POST['propertyName'] : '' }} {{old('propertyName')}}'><br/>
        ...
        value= '{{ isset($_POST['propertyAddress']) ? $_POST['propertyAddress'] : '' }} {{old('propertyAddress')}}'><br/>
        ...
        value= '{{ isset($_POST['livingArea']) ? $_POST['livingArea'] : '' }} {{old('livingArea')}}'><br/>
        ...
        value= '{{ isset($_POST['lotSize']) ? $_POST['lotSize'] : '' }} {{old('lotSize')}}'><br/>
        ...
        value= '{{ isset($_POST['yearBuilt']) ? $_POST['yearBuilt'] : '' }} {{old('yearBuilt')}}'><br/>
        ...
        value= '{{ isset($_POST['salePrice']) ? $_POST['salePrice'] : '' }} {{old('salePrice')}}'><br/>
        ...
        value= '{{ isset($_POST['taxRate']) ? $_POST['taxRate'] : '' }} {{old('taxRate')}}'><br/>
        ...
        value= '{{ isset($_POST['hoaYearly']) ? $_POST['hoaYearly'] : '' }} {{old('hoaYearly')}}'><br/>
